...
$(document).ready(function () {
    ...
    function addNewUmkm() {
        ...
        $('#add-umkm-btn').prop('disabled', true);
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control required-field" placeholder="test" id="nama_usaha_${currentIndex}" name="umkm[${currentIndex}][nama_usaha]" value="">
