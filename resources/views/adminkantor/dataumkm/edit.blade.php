                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row mb-3">
                                                <label for="status_hub_keluarga"
                                                    ...
                                                    Keluarga</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="status_hubungan_keluarga" name="status_hubungan_keluarga">
                                                        <option value="">-- Pilih Status --</option>
                                                        <option value="ANAK" {{ $pelakuUmkm->status_hubungan_keluarga == 'ANAK' ? 'selected' : '' }}>ANAK</option>
                                                        <option value="CUCU" {{ $pelakuUmkm->status_hubungan_keluarga == 'CUCU' ? 'selected' : '' }}>CUCU</option>
                                                        <option value="ISTRI" {{ $pelakuUmkm->status_hubungan_keluarga == 'ISTRI' ? 'selected' : '' }}>ISTRI</option>
                                                        <option value="SUAMI" {{ $pelakuUmkm->status_hubungan_keluarga == 'SUAMI' ? 'selected' : '' }}>SUAMI</option>
                                                        <option value="KEPALA KELUARGA" {{ $pelakuUmkm->status_hubungan_keluarga == 'KEPALA KELUARGA' ? 'selected' : '' }}>KEPALA KELUARGA</option>
                                                        <option value="MENANTU" {{ $pelakuUmkm->status_hubungan_keluarga == 'MENANTU' ? 'selected' : '' }}>MENANTU</option>
                                                        <option value="MERTUA" {{ $pelakuUmkm->status_hubungan_keluarga == 'MERTUA' ? 'selected' : '' }}>MERTUA</option>
                                                        <option value="ORANG TUA" {{ $pelakuUmkm->status_hubungan_keluarga == 'ORANG TUA' ? 'selected' : '' }}>ORANG TUA</option>
                                                        <option value="FAMILI LAIN" {{ $pelakuUmkm->status_hubungan_keluarga == 'FAMILI LAIN' ? 'selected' : '' }}>FAMILI LAIN</option>
                                                        <option value="LAINYA" {{ $pelakuUmkm->status_hubungan_keluarga == 'LAINYA' ? 'selected' : '' }}>LAINYA</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="status_perkawinan" name="status_perkawinan">
                                                        ...
                                                        <option value="KAWIN BELUM TERCATAT" {{ $pelakuUmkm->status_perkawinan == 'KAWIN BELUM TERCATAT' ? 'selected' : '' }}>KAWIN BELUM TERCATAT</option>
                                                        <option value="KAWIN TERCATAT" {{ $pelakuUmkm->status_perkawinan == 'KAWIN TERCATAT' ? 'selected' : '' }}>KAWIN TERCATAT</option>
                                                        <option value="BELUM KAWIN" {{ $pelakuUmkm->status_perkawinan == 'BELUM KAWIN' ? 'selected' : '' }}>BELUM KAWIN</option>
                                                        <option value="CERAI BELUM TERCATAT" {{ $pelakuUmkm->status_perkawinan == 'CERAI BELUM TERCATAT' ? 'selected' : '' }}>CERAI BELUM TERCATAT</option>
                                                        ...
                                                        <option value="CERAI TERCATAT" {{ $pelakuUmkm->status_perkawinan == 'CERAI TERCATAT' ? 'selected' : '' }}>CERAI TERCATAT</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <label for="alamat_sesuai_ktp"
                                                    ...
                                                    KTP</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="alamat_sesuai_ktp" name="alamat_sesuai_ktp" value="{{ $pelakuUmkm->alamat_sesuai_ktp }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="pendidikan_terakhir" name="pendidikan_terakhir">
                                                        <option value="">-- Pilih --</option>
                                                        <option value="TIDAK/BELUM SEKOLAH" {{ $pelakuUmkm->pendidikan_terakhir == 'TIDAK/BELUM SEKOLAH' ? 'selected' : '' }}>TIDAK/BELUM SEKOLAH</option>
                                                        <option value="BELUM TAMAT SD/SEDERAJAT" {{ $pelakuUmkm->pendidikan_terakhir == 'BELUM TAMAT SD/SEDERAJAT' ? 'selected' : '' }}>BELUM TAMAT SD/SEDERAJAT</option>
                                                        <option value="TAMAT SD/SEDERAJAT" {{ $pelakuUmkm->pendidikan_terakhir == 'TAMAT SD/SEDERAJAT' ? 'selected' : '' }}>TAMAT SD/SEDERAJAT</option>
                                                        <option value="SLTP/SEDERAJAT" {{ $pelakuUmkm->pendidikan_terakhir == 'SLTP/SEDERAJAT' ? 'selected' : '' }}>SLTP/SEDERAJAT</option>
                                                        <option value="SLTA/SEDERAJAT" {{ $pelakuUmkm->pendidikan_terakhir == 'SLTA/SEDERAJAT' ? 'selected' : '' }}>SLTA/SEDERAJAT</option>
                                                        <option value="DIPLOMA I/II" {{ $pelakuUmkm->pendidikan_terakhir == 'DIPLOMA I/II' ? 'selected' : '' }}>DIPLOMA I/II</option>
                                                        <option value="AKADEMI/DIPLOMA III/S. MUDA" {{ $pelakuUmkm->pendidikan_terakhir == 'AKADEMI/DIPLOMA III/S. MUDA' ? 'selected' : '' }}>AKADEMI/DIPLOMA III/S. MUDA</option>
                                                        <option value="DIPLOMA IV/STRATA I" {{ $pelakuUmkm->pendidikan_terakhir == 'DIPLOMA IV/STRATA I' ? 'selected' : '' }}>DIPLOMA IV/STRATA I</option>
                                                        <option value="STRATA II" {{ $pelakuUmkm->pendidikan_terakhir == 'STRATA II' ? 'selected' : '' }}>STRATA II</option>
                                                        <option value="STRATA III" {{ $pelakuUmkm->pendidikan_terakhir == 'STRATA III' ? 'selected' : '' }}>STRATA III</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" id="status_keaktifan" name="status_keaktifan">
                                                        <option value="">-- Pilih --</option>
                                                        <option value="AKTIF" {{ $pelakuUmkm->status_keaktifan == 'AKTIF' ? 'selected' : '' }}>AKTIF</option>
                                                        <option value="TIDAK AKTIF" {{ $pelakuUmkm->status_keaktifan == 'TIDAK AKTIF' ? 'selected' : '' }}>TIDAK AKTIF</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div id="intervensi-form-container" class="mb-4">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="tgl_intervensi"
                                                        ...
                                                        Intervensi</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" id="tgl_intervensi"
                                                            name="intervensi[tgl_intervensi]">
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="jenis_intervensi"
                                                        class="col-sm-3 col-form-label font-weight-bold">Jenis
                                                        Intervensi</label>
                                                    <div class="col-sm-9">
                                                        <select class="form-control" id="jenis_intervensi"
                                                            name="intervensi[jenis_intervensi]">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="nama_kegiatan"
                                                            name="intervensi[nama_kegiatan]"
                                                            placeholder="Masukkan nama kegiatan">
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="omset_intervensi"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control currency-input"
                                                                id="omset_intervensi" name="intervensi[omset]"
                                                                placeholder="0">
                                                        </div>
                                                    </div>
                                                </div>
